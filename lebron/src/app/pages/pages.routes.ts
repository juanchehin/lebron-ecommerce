...
const pagesRoutes: Routes = [
      // *** Acceso publico ****
      {
        ...
        children: [
            ...
            { path: 'producto/detalle/:IdProducto', loadChildren: () => import('./producto-detalle/producto-detalle.module').then(m => m.ProductoDetalleModule) },
            { path: 'comprar-ahora/producto/:IdProducto', loadChildren: () => import('./checkout/checkout.module').then(m => m.CheckoutModule) },
