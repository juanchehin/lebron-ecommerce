...
@Component({
  selector: 'app-alta-monto',
  templateUrl: './alta-monto.component.html',
  styles: []
})
export class AltaMontoInversionComponent implements OnInit {
...
// ==================================================
  ...
  altaInversion() {
      ...
      Swal.fire({
        title: '¿Desea confirmar la inversion?',
        text: "Nueva inversion para " + this.Apellidos + " " + this.Nombres,
        icon: 'warning',
