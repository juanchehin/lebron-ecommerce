...
@Component({
  selector: 'app-ventas-quimicos',
  templateUrl: './ventas-quimicos.component.html',
  styles: []
})
export class VentasQuimicosComponent implements OnInit {
...
onChangeEstado(val: any){
  this.id_estado_seleccionado = val;
}
// ==================================================
// 
// ==================================================
